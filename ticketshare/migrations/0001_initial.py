    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendee', models.ManyToManyField(related_name='attendee', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
                ('host', models.ForeignKey(related_name='host', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
